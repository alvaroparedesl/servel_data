...
#### Porcentaje de votación de izquierda ($\%I_t$)
...
El indicador anterior indica la magnitud del cambio y este indicador $\alpha$ indica la dirección del cambio. Es decir, si se movió hacía la derecha, la izquierda, aumentaron ambos o dimisniuyeron ambos.

$$
\alpha = tan(TC)^{-1}
$$

Su resultado varía entre $0$ y $360$ grados e indica la dirección del cambio.
...
Teniendo $M$ y $\alpha$ se puede saber hacía y donde y en que grado/magnitud se movió una ME determinada.
